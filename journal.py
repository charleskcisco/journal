...
_GREEN_STYLE = {
    "":                       "#16c60c bg:#070c07",
    "title":                  "#16c60c",
    "status":                 "#0e8a0e bg:#0d140d",
    "hint":                   "#0e8a0e bg:#070c07",
    "hint.sep":               "#094d09",
    "accent":                 "#2fe02f",
    "input":                  "bg:#0d140d #16c60c",
    "editor":                 "",
    "select-list":            "",
    "select-list.selected":   "bg:#0d330d",
    "select-list.empty":      "#0e8a0e",
    "preview":                "#10a010",
    "keybindings-panel":      "bg:#070c07",
    "find-panel":             "bg:#070c07",
    "form-label":             "#10a010",
    "dialog":                 "#16c60c bg:#070c07",
    "dialog.body":            "#16c60c bg:#070c07",
    "dialog text-area":       "#16c60c bg:#0d140d",
    "dialog frame.label":     "#16c60c bold",
    "dialog shadow":          "bg:#0d330d",
    "button":                 "#16c60c bg:#0d330d",
    "button.focused":         "#070c07 bg:#16c60c",
    "label":                  "#16c60c",
    "md.heading-marker":      "#094d09",
    "md.heading":             "bold #2fe02f",
    "md.list-marker":         "italic #0d6e0d",
    "md.quote-marker":        "italic #0d6e0d",
    "md.wikilink":            "underline #2fe02f",
    "md.frontmatter":         "#0d6e0d",
    "md.bold":                "bold #2fe02f",
    "md.italic":              "italic",
    "md.code":                "#10a010",
    "md.footnote":            "italic #2fe02f",
    "md.link":                "underline #2fe02f",
